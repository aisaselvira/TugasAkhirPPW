...
<div class="container">
	<h2 style="width: 100%; border-bottom: 2px solid #0000; text-align:center; font-size:28px"><b>Photocard</b></h2>
	<hr>
    <div class="row">
        <?php 
        $result = mysqli_query($conn, "SELECT * FROM produk WHERE id_kategori = 'KT0002'");
